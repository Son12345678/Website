...
@section('contents')
    <div class="w-full h-auto flex flex-col">
        <div class="text-center text-2xl font-semibold p-4 bg-emerald-300">
            <p>DASHBOARD</p>
        </div>
        <div class="flex flex-row mt-8 justify-center text-gray-700">
            <div class="mr-2 border-4 border-teal-700 overflow-hidden flex flex-col pt-10 rounded-xl relative">
                <span class="absolute left-0 top-0"><svg width="80px" height="80px" viewBox="0 0 1024 1024" class="icon"
                        version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000"
                        stroke-width="0.01024">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M512 301.2m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0Z" fill="#E73B37"></path>
                            <path
                ...
                <p class=" text-6xl text-center font-bold ">23</p>
                <p class="text-center font-bold pb-5">New Order</p>
                <a class="bg-gray-600 bg-opacity-50 text-center px-20 text-gray-100 font-bold hover:bg-opacity-100"
                    href="#">More info</a>
            </div>
            <div class="mr-2 border-4 border-teal-700 overflow-hidden flex flex-col pt-10 rounded-xl relative">
                <span class="absolute left-0 top-0"><svg width="81px" height="81px" viewBox="0 0 1024 1024"
                        class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#6a6a7c" stroke="#6a6a7c"
                        stroke-width="10.24">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <p class=" text-6xl text-center font-bold ">23</p>
                <p class="text-center font-bold pb-5">Bounce Rate</p>
                <a class="bg-gray-600 bg-opacity-50 text-center px-20 text-gray-100 font-bold hover:bg-opacity-100"
                    href="#">More info</a>
            </div>
            <div class="mr-2 border-4 border-teal-700 overflow-hidden flex flex-col pt-10 rounded-xl relative">
                <span class="absolute left-0 top-0"><svg width="80px" height="80px" viewBox="0 0 1024 1024"
                        class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#6a6a7c" stroke="#6a6a7c"
                        stroke-width="11.264">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M512 616.2m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0Z" fill="#E73B37"></path>
                            <path d="M511.6 656.9m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0Z" fill="#E73B37"></path>
                            <path d="M512.4 697.7m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0Z" fill="#E73B37"></path>
                            <path
                ...
                <p class=" text-6xl text-center font-bold ">23</p>
                <p class="text-center font-bold pb-5">User Registration</p>
                <a class="bg-gray-600 bg-opacity-50 text-center px-20 text-gray-100 font-bold hover:bg-opacity-100"
                    href="#">More info</a>
            </div>
            <div class="mr-2 border-4 border-teal-700 overflow-hidden flex flex-col pt-10 rounded-xl relative">
                ...
                <p class=" text-6xl text-center font-bold ">23</p>
                <p class="text-center font-bold pb-5">Unique Visitors</p>
                <a class="bg-gray-600 bg-opacity-50 text-center px-20 text-gray-100 font-bold hover:bg-opacity-100"
                    href="#">More info</a>
            </div>
