...
<body id="app" class="w-screen h-screen bg-teal-100">
    @include('app')
    <div class="flex justify-center" >
        <a class="text-center py-2 bg-emerald-700 text-white text-xl px-40 mt-4 rounded-xl" href="/create">
            Create Products
        </a>
    </div>
   
    
    <form-info :products="{{ $products }}"/>
...
hello --}}
    {{-- <div
        class="relative flex items-top justify-center min-h-screen bg-red-600 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
